...
export class Title extends Phaser.Scene {
  ...
  createInteractiveText(x: number, y: number, text: string | string[], style: Phaser.Types.GameObjects.Text.TextStyle | undefined) {
  ...
  create() {
    ...
    const playText = this.createInteractiveText(430, 650, "PLAY", { fontSize: "100px" });
    ...
    const chineseText = this.createInteractiveText(430, 800, "Chinese", { fontSize: "50px"});
    ...
    const englishText = this.createInteractiveText(930, 800, "English", { fontSize: "50px"});
    ...
    const hebrewText = this.createInteractiveText(700, 800, "Hebrew", { fontSize: "50px"});
